...
Команда Finance — Хакатон ЛЦТ

📄 Лицензия
Этот проект разработан в рамках хакатона ЛЦТ. Подробности лицензии уточняются.
...
- Современную badges-шапку с версиями технологий
- Структурированное описание проекта
...
Формат оптимизирован для GitHub и дает полное представление о проекте.
...
<!-- Fallback: кликабельное превью для платформ без поддержки iframe -->
<a href="https://rutube.ru/video/871978b7e0cd45e07e6e0125ee97ec09/" target="_blank">
  <img src="https://img.shields.io/badge/▶️_Смотреть_видео-Rutube-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="Смотреть видео на Rutube" />
</a>

<br><br>

<!-- Встроенный плеер (работает на большинстве платформ) -->
<iframe width="720" height="405" src="https://rutube.ru/play/embed/871978b7e0cd45e07e6e0125ee97ec09/?p=null" frameBorder="0" allow="clipboard-write; autoplay" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>

<br>
<sub>Если видео не отображается, <a href="https://rutube.ru/video/871978b7e0cd45e07e6e0125ee97ec09/" target="_blank">откройте его на Rutube</a></sub>
...
│   │
│   ├── rosreestr/                   # Модуль работы с данными Росреестра
│   │   ├── rosreestr_loader.py      # Загрузка официальных границ субъектов РФ
│   │   └── README.md                # Документация модуля
│   │
│   ├── log/                         # Логи системы
...
**Файлы:** `Backend/rosreestr/` • [Документация](Backend/rosreestr/README.md)
...
- Конвертация XML-схем Росреестра в SHP формат
- Расчет площади регионов в км²
- Определение центроидов для каждого региона

**Использование:**
```python
from rosreestr.rosreestr_loader import load_rosreestr_boundaries, process_shp_to_db

# Загрузка субъектов Федерации из шейп-файлов Росреестра
shp_data = load_rosreestr_boundaries("regions_rosreestr.shp")
if shp_data:
    process_shp_to_db(shp_data)
```

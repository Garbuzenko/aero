...
async function initMap() {
   ...
   function showTooltip(properties) {
    if (properties) {
      $('#jsTooltip').html('Количество полётов: '+properties.totalFlights+'<br>Количество БПЛА: '+properties.totalBla+'<br>Период: '+properties.period+'<br>Регион: '+properties.region).removeClass('hidden');
    }
   }
